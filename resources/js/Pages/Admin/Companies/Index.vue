<template>
    ...
    <div class="flex flex-col gap-3 px-3 h-full">
        <div class="flex justify-between items-center h-10">
            ...
            >
                <PlusSquareIcon />
                <span class="hidden text-sm md:block">Tambah Perusahaan</span>
            </button>
        </div>
                ...
                <table class="min-w-full text-sm">
                    <thead>
                        <tr>
                            ...
                            <th
                                v-if="can('companies.edit') || can('companies.delete')"
                                class="py-3 bg-gray-100 border border-gray-200 dark:border-gray-600 dark:bg-gray-800"
                            >
                                <div class="flex justify-center items-center">
                                    <p
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            @click.stop="openConfirmModal(company)"
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="space-y-1 text-sm">
                            ...
                            <div class="flex items-center gap-4">
                                <div v-if="logoPreview || (isEditMode && selectedItem?.logo)" class="flex-shrink-0">
                                    <img
                                        :src="logoPreview || selectedItem?.logo"
                                        alt="Logo Preview"
...
const breadcrumbs = [{ label: "Menu Utama" }, { label: "Perusahaan" }];
...
function changeSort(column) {
    ...
    fetchCompanies({ sortBy: column, sortDirection: direction });
}
...
function saveCompany() {
    ...
    if (isEditMode.value) {
        ...
        router.post(route("companies.update", form.id), formData, {
...
const destroyData = () => {
    ...
    router.delete(route("companies.destroy", selectedItem.value.id), {
        onSuccess: () => {
            closeConfirmModal();
        },
        preserveScroll: true,
